...
#undef DEFINE_LEXER_GETTER
    ...
    regex_t r_char{ R"('(?:([^'"\\])|(?:\\(?:([abfnrtv'\?"\\])|(?:0(\d{1,2}))|(\d)|(?:x([[:xdigit:]]{1,2})))))')", std::regex::ECMAScript | std::regex::optimize };
    ...
    regex_t r_space{ R"((\s)+?)", std::regex::ECMAScript | std::regex::optimize };//([ ]+)|((?:\r\n\t)+)|(\n+)
    regex_t r_comment{ R"((?://([^\r\n]*))|(?:/\*([([:print:]|(\t))(\n|\r)]*?)\*/))", std::regex::ECMAScript | std::regex::optimize };//regex_t r_comment{ R"((?://([^\r\n]*))|(?:/\*([([:print:]|(\t))(\n|\r)]*?)\*/))", std::regex::ECMAScript | std::regex::optimize };
    ...
    regex_t r_operator[4] =
    {
        ...
        regex_t{ R"((^%:%:$))", std::regex::ECMAScript | std::regex::optimize }
    };
};
